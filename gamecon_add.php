    ...
    <body>        
        <div class="container">
            ...
            <div class="row">
                ...
                <h4>เพิ่มข้อมูลอุปกรณ์เครื่องเล่น</h4>    
                <?php
                    if(isset($_GET['submit'])){
                        $gc_name = $_GET['gc_name'];
                        $sql = "insert into game (gc_name) values ('$gc_name')";
                ...
                ?>
                    <form class="form-horizontal" role="form" name="gamecon_add" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <div class="form-group">
                            <label for="gc_name" class="col-md-2 col-lg-2 control-label">อุปกรณ์เครื่องเล่น</label>
                            <div class="col-md-10 col-lg-10">
                                <input type="text" name="gc_name" id="gc_name" class="form-control">
                            </div>    
                        </div>
                        <div class="form-group">
                            <div class="col-md-10 col-lg-10">
