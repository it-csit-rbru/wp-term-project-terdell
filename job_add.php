            ...
            <div class="row">
                ...
                <?php
                    if(isset($_GET['submit'])){
                        ...
                        mysqli_close($conn);
                        echo "เพิ่มตำแหน่ง $job_name เรียบร้อยแล้ว<br>";
                        echo '<a href="job_list.php">แสดงตำแหน่งงานทั้งหมด</a>';
                    }else{
                ?>
                    <form class="form-horizontal" role="form" name="job_add" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <div class="form-group">
                            <label for="job_name" class="col-md-2 col-lg-2 control-label">ตำแหน่งงาน</label>
