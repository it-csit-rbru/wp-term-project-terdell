                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                    ...
                    <?php
                        ...
                        if(isset($_GET['submit'])){
                            ...
                            $user_nname = $_GET['user_nname'];
                            $user_tel = $_GET['user_tel'];
                            $user_ad = $_GET['user_ad'];
                            $user_date = $_GET['user_date'];
                            $sql = "update user set";
                            $sql .= "user_ttl_id='$user_ttl_id'user_fname='$user_fname',user_lname='$user_lname',user_nname='$user_nname',user_tel='$user_tel',user_ad='$user_ad',user_date='$user_date' ";
                            $sql .="where user_id='$user_id' ";
                            include 'connectdb.php';
                            mysqli_query($conn,$sql);
                            mysqli_close($conn);
                            echo "แก้ไขข้อมูลผู้ใช้  $user_ttl_id $user_fname $user_lname $user_nname $user_tel $user_ad $user_date เรียบร้อยแล้ว<br>";
                    ...
                    <form class="form-horizontal" role="form" name="user_edit" action="<?php echo $_SERVER['PHP_SELF'];?>">
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-lg-10">
                                ...
                                <?php
                                    ...
                                    $fuser_nname = $row2['user_nname'];
                                    $fuser_tel = $row2['user_tel'];
                                    $fuser_ad = $row2['user_ad'];
                                    $fuser_date = $row2['user_date'];
                        ...
                        <div class="form-group">
                            <label for="user_nname" class="col-md-2 col-lg-2 control-label">ชื่อเล่น</label>
                            <div class="col-md-10 col-lg-10">
                                <input type="text" name="user_nname" ID="user_nname" class="form-control" 
                                       value="<?php echo $fuser_nname;?>">
                            </div>    
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="user_date" class="col-md-2 col-lg-2 control-label">วันเกิด</label>
                            <div class="col-md-10 col-lg-10">
                                <input type="date" name="user_date" ID="user_date" class="form-control" 
                                       value="<?php echo $fuser_date;?>">
                            </div>    
                        </div> 
                        <div class="form-group">
                            <div class="col-md-10 col-lg-10">
